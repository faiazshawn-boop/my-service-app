...
# এই মানগুলো Render.com-এর "Environment" সেকশন থেকে আসবে
TOKEN = os.environ.get("BOT_TOKEN")
ADMIN_ID = int(os.environ.get("ADMIN_ID"))
ADMIN_USERNAME = os.environ.get("ADMIN_USERNAME")
RENDER_APP_URL = os.environ.get("RENDER_EXTERNAL_URL") # Render এটি নিজে সেট করবে
...
# ===== গুগল শীট কনফিগারেশন =====
try:
    # Render.com-এর "Environment" থেকে JSON স্ট্রিং লোড করা
...
def get_short_data_for_table(order_data):
    ...
    if not nid and not dob:
        # .strip() কে ৮টি বন্ধনীর শেষে একই লাইনে যোগ করা হয়েছে
        nid = order_data.get("বাংলালিংক নাম্বার", 
              ...
              order_data.get("নগদ নাম্বার", "")))))))).strip() # <-- দেখুন, .strip() এখন এই লাইনে
        dob = ""
